...
class GererReservationAdminWindow(tk.Toplevel):
    def __init__(self, parent):
        ...
        self.title('Gérer les réservations')
        ...
        #Menu Label Frame
        self.reservation_conf_lf = ttk.LabelFrame(self.down_frame, text="Les réservations")
